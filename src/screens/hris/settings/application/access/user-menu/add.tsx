...
const UsermenuAdd = () => {
    return (
        <Page breadCrumb="Settings|Application Settings|Access|User Menu|Add">
            <Form action="settings/userMenu.Add">
                ...
                <Input type="checkbox" label="Status" name="status" data="Active=1" />
                <Input type="text" label="Order" size="2" placeholder="Menu Order" name="menu_order" defaultValue="1" required />
