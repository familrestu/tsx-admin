...
class Header extends React.Component<AppState> {
    ...
    AddOpenDrowndownListener() {
        const arrBtnDropDown = document.querySelectorAll('.header .btn-open-dropdown');
    ...
    render() {
        ...
        return (
            <div id="header" className="header position-relative d-flex align-items-center shadow-sm">
                <div className="position-relative h-100 d-flex align-items-center justify-content-center" style={{ flex: '0.5 1 auto' }}>
                    <Button className="mr-4 btn-ripple btn-ripple-primary" onClick={() => this.ToggleNavbarHandler()}>
                ...
                <div className="position-relative h-100 d-flex align-items-center justify-content-end" style={{ flex: '1 1 auto' }}>
                    <NotificationBells />
